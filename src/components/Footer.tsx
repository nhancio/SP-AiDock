        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">AiDock</span>
            </Link>
            <p className="text-gray-400 mb-6 max-w-md">
              Discover and explore the best AI tools and agents. From content creation to automation, 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/category/content-creation" className="text-gray-400 hover:text-white transition-colors">
                  Content Creation
                </Link>
              </li>
              <li>
                <Link to="/category/productivity" className="text-gray-400 hover:text-white transition-colors">
                  Productivity
                </Link>
              </li>
              <li>
                <Link to="/category/analytics" className="text-gray-400 hover:text-white transition-colors">
                  Analytics
                </Link>
              </li>
              <li>
                <Link to="/category/automation" className="text-gray-400 hover:text-white transition-colors">
                  Automation
                </Link>
              </li>
            </ul>
